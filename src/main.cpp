...
int main(int argc, const char **argv)
{
    ...
    std::cout << "The map coordinate begins at (0,0) and ends at (100,100) in the upper right corner.\n";

    std::cout << "Please provide start x (between 0 to 100): ";
    std::cin >> start_x;

    std::cout << "Please provide start y (between 0 to 100): ";
    std::cin >> start_y;

    std::cout << "Please provide end x (between 0 to 100): ";
    std::cin >> end_x;

    std::cout << "Please provide end y (between 0 to 100): ";
    std::cin >> end_y;
    ...
    // std::cout << "\nDistance: " << route_planner.GetDistance() << " in meters." << std::endl;
